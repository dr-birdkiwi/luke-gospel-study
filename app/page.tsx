...
const chapterGuidesByChapter: Record<number, string[]> = {
  ...
  19: ['王先进入人的家：撒该与“今天”的救恩（19:1–10）', '王的国不按人的时间表显现：十锭银子与等候中的忠心（19:11–27）', '王走近圣城：和平的欢呼、为城的眼泪与圣殿的恢复（19:28–48）'],
...
const chapterSummaries = [
  ...
  '耶稣先把“今天”的救恩带进撒该的家，又纠正人对立即国度的期待；祂走近耶路撒冷，以和平、眼泪和圣殿行动显明自己是哪一种王。',
