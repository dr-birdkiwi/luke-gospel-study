...
const chapterNotes: StudyNote[] = [
  ...
  { range: '1:5–25', title: '你的祈祷已经被听见了', scene: '在耶路撒冷的圣殿里，祭司按班次服事，圣殿外的百姓在等待。香烟从圣所升起，撒迦利亚独自进去服事；就在这套延续已久的敬拜秩序里，一个年老、无子的家庭忽然被神点名。', scripture: '撒迦利亚与以利沙伯年老无子；天使宣告约翰将使许多人回转，预备主的道路。', literal: '神的回应不只是一个家庭多年等待的转折，也把这个孩子放在救赎历史的前奏中。撒迦利亚的迟疑也被保留下来：圣经没有把信心写成没有挣扎的样子。', context: '希律大帝仍在位；圣殿是犹太人共同敬拜与身份记忆的中心。祭司按班次服事，香坛前的烟与外面百姓的祷告同场出现；路加把私人愿望放回公共敬拜。经文说的是圣所的“殿”，不是一年一次的大祭司进入至圣所。', connection: '可串联玛 3:1、玛 4:5–6 与赛 40:3，留意“预备道路”和“使父亲的心转向儿女”的先知回声；也可对照启 8:3–4，观察香与祷告在新约中的象征联系。', life: '讨论：长期没有答案的祷告会怎样塑造我们？操练：把一个等待中的祷告写成“我期待什么／神可能正在预备什么／今天我仍可忠心做什么”三行，和组员彼此代祷。' },
  { range: '1:26–38', title: '我没有出嫁，怎么有这事呢？', scene: '加利利的拿撒勒不是权力中心，只是一座普通村落。马利亚正在一个有婚约承诺、也有社会眼光的生活阶段；她没有站在耶路撒冷的权力中心，而是在拿撒勒的日常生活中，听见一个会改变名誉、婚姻和未来的消息。', scripture: '天使向马利亚宣告耶稣的降生，马利亚以“情愿照你的话成就在我身上”回应。', literal: '马利亚先提出问题，再作出顺服；她不是掌控计划，而是在不确定、可能受误解的处境中信靠神的应许。“主的使女”是主动把自己交给神，不是被动失去声音。', context: '拿撒勒是加利利的小村落，远离耶路撒冷的宗教权力中心。“已经许配”在当时是有社会与法律重量的婚约阶段，不等同于现代约会；经文没有交代马利亚年龄，不能用后来的猜测代替文本。', connection: '可对照撒下 7:12–16、诗 2:7 与赛 9:6–7，体会“大卫宝座”“至高者的儿子”如何把婴孩放进王权应许；也可回看太 1:18–25，比较马太与路加的叙事焦点。', life: '讨论：我们是否只在答案清楚时才愿意顺服？操练：找出一个你一直想先掌控结果的决定，写下一个既诚实又可执行的顺服行动，并邀请可信任的组员陪你辨别。' },
  { range: '1:39–45', title: '我主的母到我这里来，这是从哪里得的呢？', scene: '马利亚从加利利南下，走进犹大山地一户普通家庭。她还没有任何公开证明，只有一个难以向人解释的应许；以利沙伯一听见她问安，腹中的孩子跳动，家里的空气先于众人承认神正在工作。', scripture: '马利亚探访以利沙伯；路加借着约翰在母腹中的跳动，描写两个家庭同时被神的应许触动。', literal: '神的应许没有把人孤立，反而把两个家庭带入彼此确认、彼此祝福的关系。以利沙伯没有抢走马利亚的故事，她用祝福帮助对方听见自己正在经历的恩典。这里的“孩子跳动”是路加叙事中的神学记号，不应被误读为现代医学意义上的胎儿交流。', context: '从拿撒勒到犹大山地是跨地区旅程；“山地”连接着犹大传统中的圣城、祭司家庭和先知记忆。路加让女性成为最早确认应许的见证者，打破“只有公开权力才算重要见证”的阅读习惯。', connection: '可连到创 18:1–15、创 21:1–7 与撒上 1–2 章，比较不可能怀孕的故事如何成为神信实的记号；也可回看路 1:15、41，留意圣灵在出生叙事中的主动工作。', life: '讨论：我们的信仰群体是让人更确定神恩典，还是让人更害怕被评判？操练：这两周主动向一位正在等待或承担压力的人说一句具体的祝福，不急着给建议。' },
  { range: '1:46–56', title: '我心尊主为大，直到回到家中', scene: '两位妇女在家中相对而立，一个年长，一个正处在婚约阶段；她们都面对身体和未来的巨大改变。马利亚没有把歌唱成私人日记，而是把自己的怀孕放进亚伯拉罕、以色列和世世代代受压者的故事里。歌唱之后，她仍在以利沙伯那里住了约三个月，然后回到自己的家；神的应许既进入宏大的历史，也落在一段真实的等待与归途中。', scripture: '马利亚的诗歌颂赞神顾念卑微者，使饥饿的得饱足，并记念对亚伯拉罕的应许；她在以利沙伯那里住了约三个月，随后回家。', literal: '赞美不是逃避现实；它重新命名现实。马利亚反复使用强有力的动作描写神：看顾、施展大能、叫有权柄的降卑、叫卑微的升高、叫饥饿的得饱足。第 56 节把诗歌带回日常：信心的歌唱之后，仍有一段需要生活、等待并回家的路。', context: '古代敬拜常用诗歌保存群体记忆；路加把这首歌放在个人故事与以色列历史的交界处。它不是温柔的私人抒情，而是对神如何翻转骄傲、权势与匮乏的神学宣告。马利亚住了约三个月后回家，也把尊主颂与下一段约翰出生的叙事连接起来。', connection: '可对照撒上 2:1–10、诗 113:5–9、诗 146:5–9，听见“神抬举卑微者”的旧约回声；再回看路 4:18–19，观察耶稣如何把这条线带入公开事奉。', life: '讨论：我们的敬拜是否只说“我得着了什么”，还是也看见神对弱小者、公义与群体的心意？操练：本周写一段三节的赞美：一节记念神已经做过的事，一节为被忽略的人代求，一节写出你愿意参与的行动。' },
  { range: '1:57–66', title: '他的名字是约翰', scene: '孩子出生，亲属和邻居听见消息，来一同欢喜。大家以为名字会沿用家族传统；一个刚恢复说话的父亲却拿起写字板，写下一个不属于家族惯例、却属于神应许的名字。家中的惊讶，变成整座山地的议论。', scripture: '约翰出生后，父母没有按家族习惯取名，而是顺服天使的吩咐。', literal: '名字表明这孩子属于神的计划，不被家族传统或人的意见重新定义。撒迦利亚恢复说话不是为了证明自己，而是让邻舍重新敬畏神，并追问这孩子将来要成为什么样的人。', context: '亲属按家族命名的期待很自然，但路加刻意写出期待与神话语之间的张力。“约翰”意为神施恩的名字，与整章“神记念、神成就”的主题相连；不要把它读成一个人的自我品牌。', connection: '可串联路 1:13 与路 1:20，留意名字与说话的恢复都指向神的应许；也可回看士 13:2–14，比较参孙出生预告与约翰作为分别为圣、预备道路者的相似与不同。', life: '讨论：我们有没有把家族、教会或职场对人的期待，当成神对人的最终定义？操练：为一位年轻人或正在寻找方向的组员写下三句“神已经赐给他的恩典”，用祝福代替贴标签。' },
